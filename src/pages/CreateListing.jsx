...
import {getStorage,ref,uploadByesResumable,getDownloadURL, uploadBytesResumable} from 
"firebase/storage"; 
    ...
    <main className='max-w-md px-2 mx-auto'>
        ...
        <form onSubmit={onSubmit}>
            ...
            <div className='flex'>
                ...
                onClick={onChange} className={`mr-3 py-3 px-7 font-medium text-sm uppercase 
                shadow-md rounded transition duration-150 ease-in-out hover:shadow-lg 
                focus:shadow-lg active:shadow-lg w-full 
                ${ type==="rent" ? "bg-white text-black" :"bg-slate-600 text-white"}`}>sell
                </button>
                <button type='button' id='type' value="rent" 
                onClick={onChange} className={`ml-3 py-3 px-7 font-medium text-sm uppercase 
                shadow-md rounded transition duration-150 ease-in-out hover:shadow-lg 
                focus:shadow-lg active:shadow-lg w-full 
                ${ type==="sale" ? "bg-white text-black" :"bg-slate-600 text-white"}`}>rent
                </button>
            </div>
            <p className='text-lg mt-6 font-semibold'>Name</p>
            <input type="text" id='name' value={name} onChange={onChange} placeholder= "Name" maxLength="32" 
            minLength="10" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white 
            border border-gray-300 rounded transition duration-150 ease-in-out 
            focus:text-gray-700 focus:bg-white focus:border-slate-700 mb-6'/>
            <div className='flex space-x-6 mb-6'>
                <div>
                    <p className='w-full text-lg font-semibold'>Beds</p>
                    <input type="number" id='bedrooms' value={bedrooms} min ="1" max="50"
                ...
                <div>
                    ...
                    <input type="number" id='bathrooms' value={bathrooms} min ="1" max="50"
                    onChange={onChange} required 
                    className='px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 
                    rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white
                    focus:border-slate-700 text-center'/>
            ...
            <div className='flex'>
                ...
                shadow-md rounded transition duration-150 ease-in-out hover:shadow-lg 
                focus:shadow-lg active:shadow-lg w-full 
                ${ !parking ? "bg-white text-black" :"bg-slate-600 text-white"}`}>Yes
                </button>
                <button type='button' id='parking' value={false}
                onClick={onChange} className={`ml-3 py-3 px-7 font-medium text-sm uppercase 
                shadow-md rounded transition duration-150 ease-in-out hover:shadow-lg 
                focus:shadow-lg active:shadow-lg w-full h
                ${ parking ? "bg-white text-black" :"bg-slate-600 text-white"}`}>No
                </button>
            </div>
            ...
            <div className='flex'>
                ...
                shadow-md rounded transition duration-150 ease-in-out hover:shadow-lg 
                focus:shadow-lg active:shadow-lg w-full 
                ${ !furnished ? "bg-white text-black" :"bg-slate-600 text-white"}`}>Yes
                </button>
                <button type='button' id='furnished' value={false} 
                onClick={onChange} className={`ml-3 py-3 px-7 font-medium text-sm uppercase 
                shadow-md rounded transition duration-150 ease-in-out hover:shadow-lg 
                focus:shadow-lg active:shadow-lg w-full 
                ${ furnished ? "bg-white text-black" :"bg-slate-600 text-white"}`}>No
                </button>
            </div>
            <p className='text-lg mt-6 font-semibold'>Address</p>
            <textarea type="text" id='Address' value={Address} onChange={onChange} placeholder= "Address"  
            required className='w-full px-4 py-2 text-xl text-gray-700 bg-white 
            border border-gray-300 rounded transition duration-150 ease-in-out 
            focus:text-gray-700 focus:bg-white focus:border-slate-700 mb-6'/>
            {!geoLocationEnabled && (
                <div className="flex space-x-6 justify-start mb-6 ">
                    <div>
                        ...
                        min="-90"
                        max="90"
                        className="w-full text-xl px-4 py-2 text-gray-700 bg-white border border-gray-300
            ...
            <button type='button' id='offer' value={true}
                ...
                shadow-md rounded transition duration-150 ease-in-out hover:shadow-lg 
                focus:shadow-lg active:shadow-lg w-full 
                ${ !offer ? "bg-white text-black" :"bg-slate-600 text-white"}`}>Yes
                </button>
                <button type='button' id='offer' value={false} 
                onClick={onChange} className={`ml-3 py-3 px-7 font-medium text-sm uppercase 
                shadow-md rounded transition duration-150 ease-in-out hover:shadow-lg 
                focus:shadow-lg active:shadow-lg w-full 
                ${ offer ? "bg-white text-black" :"bg-slate-600 text-white"}`}>No
                </button>
                </div>
                ...
                <div className='mb-6'>
                    ...
                    multiple
                    required
                    className='px-3 py-1.5 w-full text-gray-700 bg-white border border-gray-300 
